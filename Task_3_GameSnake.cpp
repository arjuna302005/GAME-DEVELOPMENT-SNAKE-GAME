...
int main()
{
    ...
    while (window.isOpen())
    {
        ...
        while (window.pollEvent(e))
        {
            ...
            {
                if (e.key.code == Keyboard::Left && dir != 2) dir = 1;
                if (e.key.code == Keyboard::Right && dir != 1) dir = 2;
                if (e.key.code == Keyboard::Up && dir != 0) dir = 3;
                if (e.key.code == Keyboard::Down && dir != 3) dir = 0;
            }
